...
var ProjectS = (function () {
  ...
  function seedDemo() {
    state.columns = ['No', 'Task-ID', 'Task name', 'Task Relate', 'Purpose', 'PIC', 'Organization', 'Date', 'Due Date', 'Value', 'Note', 'Internal', 'Duration', 'Status'];
    state.options = {
    ...
    state.tasks = [
      ...
      { row: 4, 'No': 3, 'Task-ID': 'Task-003', 'Task name': 'Les SAT/IELTS', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Wardaya', 'Date': '2026-07-21', 'Due Date': '2026-09-24', 'Value': 3300000, 'Note': 'setiap selasa dan kamis 20 kali pertemuan', 'Internal': false, 'Duration': '46 days left', 'Status': 'In-Progress' },
      { row: 5, 'No': 4, 'Task-ID': 'Task-004', 'Task name': 'Recommendation letter', 'Task Relate': 'Task-010', 'Purpose': 'Global', 'PIC': 'Echo', 'Organization': 'Jessica', 'Date': '2026-07-10', 'Due Date': '2026-09-30', 'Value': '', 'Note': 'piano', 'Internal': false, 'Duration': '52 days left', 'Status': 'In-Progress' },
      { row: 6, 'No': 5, 'Task-ID': 'Task-005', 'Task name': 'Surat keterangan OSIS', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Kemurnian', 'Date': '2026-07-20', 'Due Date': '2026-07-27', 'Value': '', 'Note': 'untuk daftar Binus', 'Internal': false, 'Duration': 'Overdue by 13 days', 'Status': 'Done' },
      { row: 7, 'No': 6, 'Task-ID': 'Task-006', 'Task name': 'Online test BINUS', 'Task Relate': 'Task-001', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Binus', 'Date': '2026-08-01', 'Due Date': '2026-08-05', 'Value': '', 'Note': 'Zoom test jam 14:00', 'Internal': false, 'Duration': '', 'Status': 'Done' },
      { row: 8, 'No': 7, 'Task-ID': 'Task-007', 'Task name': 'Pembayaran binus jurusan Ai semester 1', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Binus', 'Date': '2026-08-10', 'Due Date': '', 'Value': 27300000, 'Note': 'Deadline 12 Agust 2026', 'Internal': false, 'Duration': '', 'Status': 'In-Progress' },
      { row: 9, 'No': 8, 'Task-ID': 'Task-008', 'Task name': 'Pembayaran biaya peralatan 1x binus', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Binus', 'Date': '2027-09-01', 'Due Date': '', 'Value': 10200000, 'Note': '1 x bayar selama kuliah', 'Internal': false, 'Duration': '', 'Status': 'Not Started' },
      { row: 10, 'No': 9, 'Task-ID': 'Task-009', 'Task name': 'Pembayarab biaya lab', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Binus', 'Date': '2027-09-01', 'Due Date': '', 'Value': 3250000, 'Note': 'pembayaran semester 1-4', 'Internal': false, 'Duration': '', 'Status': 'Not Started' },
      { row: 11, 'No': 10, 'Task-ID': 'Task-010', 'Task name': 'Kobi les Ielts', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Kobi Education', 'Date': '2026-08-15', 'Due Date': '2026-10-04', 'Value': 3900000, 'Note': '16 x pertemuan, setiap sabtu dan minggu jam 13.00-15.00', 'Internal': false, 'Duration': '', 'Status': 'In-Progress' },
      { row: 12, 'No': 11, 'Task-ID': 'Task-011', 'Task name': 'Recommendation letter', 'Task Relate': '', 'Purpose': 'Local', 'PIC': 'Golf', 'Organization': 'Kemurnian', 'Date': '2026-08-13', 'Due Date': '2026-10-31', 'Value': '', 'Note': 'Bu anissa', 'Internal': false, 'Duration': '', 'Status': 'In-Progress' }
    ];
  }
